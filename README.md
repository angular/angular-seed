# angular-seed-coffee — the seed for AngularJS apps [![build](https://api.travis-ci.org/daggerok/angular-seed.svg?branch=master)](https://api.travis-ci.org/daggerok/angular-seed.svg?branch=master)
